...
from_email = "khuyenbacyena@gmail.com"  # The sender email address
password = "xuva vdiv xmtn pwxr"  # 16-digits password generated via: https://myaccount.google.com/apppasswords
to_email = "nghiem.lg200104@gmail.com"  # The receiver email address
